...
- [justjavac 你可能不知道的前端知识点](https://github.com/justjavac/the-front-end-knowledge-you-may-not-know)
- [puppeteer 破解滑动验证码](https://medium.com/@filipvitas/how-to-bypass-slider-captcha-with-js-and-puppeteer-cd5e28105e3c)
- [validation library 变量类型检查](https://www.npmjs.com/package/bycontract)
- [schema-utils 变量类型检查](https://github.com/webpack/schema-utils)
- [大迁世界博客](https://github.com/qq449245884/xiaozhi)

## 优秀文章

- [addEventListener passive 提升页面滚动性能](https://github.com/justjavac/the-front-end-knowledge-you-may-not-know/blob/master/archives/006-web-scrolling-performance-optimization-passive-event-listeners.md)
...
- [boxmodel: js 盒子模型，offset, scroll, client 等等](boxmodel.md)
...
- [encode-url: URL 编/解码](encode-url.md)
...
- [virtual table: 虚拟列表](virtual-table.md)
- [vue-vs-jquery: vue 与 jquery 的区别](vue-vs-jquery.md)
- [xss: xss 的原理及防御](xss.md)
...
- [线上出 bug 了？别怕，这么定位！](https://blog.fundebug.com/2019/06/01/use-sourcemap-to-debug-online-error/)
